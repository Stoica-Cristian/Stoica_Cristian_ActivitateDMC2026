...
public class ImagesActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        imageInfoList.add(new ProductImageInfo("https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=200", "Smartphone", "https://en.wikipedia.org/wiki/Smartphone"));
        imageInfoList.add(new ProductImageInfo("https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=200", "Laptop", "https://en.wikipedia.org/wiki/Laptop"));
